...
# -*- coding: utf-8 -*-
"""
Created on Tue Jun  4 09:56:14 2019
...
ansover = 'No'
if prezero == 'No':
    anszero = input("Do you need zero combination (not overscan)? Yes or No: ")
    if anszero == 'No':
        ansover = input("Is the image zero corrected through overscan? Yes or No: " )
if preflat == 'No':
    ansflat = input("Do you need flat combination? Yes or No: ")
if anszero == 'Yes':
    print('\n')
    print("ZERO COMBINE")
    print('\n')
...
if oneorno != 'Yes':
    ...
    if ansover == 'Yes':
        ...
        for line in infile: 
            ...
            filelist.append(line+ 'overscan' + str(i) + '.fits')
            i += 1
if oneorno == 'Yes':
    if ansover == 'No':
